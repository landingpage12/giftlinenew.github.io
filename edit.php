...
<html>
    ...
    <body>
        ...
        <div class="card-body" id="order">
            ...
            $alamat = $_GET['alamat'];
            $data = mysqli_query($db, "SELECT * FROM pemesanan WHERE alamat='$alamat'");
            ...
            <form action="aksi_edit.php" method="post" name="register" enctype="multipart/form- data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $d['alamat']; ?>" readonly>
                        <!-- read only-->
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="toko" name="toko" value="<?php echo $d['toko']; ?>">
                        <option value="SS FLORIST">SS FLORIST</option>
                        <option value="Taman Purbakala Sriwijaya">Taman Purbakala Sriwijaya</option>
                        <option value="Museum SMB II">Museum SMB II</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="tgl_ambil" class="col-sm-2 col-form-label">Tanggal Pengambilan</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="tgl_kunjungan" name="tgl_ambil" value="<?php echo $d['tgl_ambil']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="jmlh_pesanan" class="col-sm-2 col-form-label">Jumlah Pesanan</label>
                    <div class="col-sm-10">
                    <input type="number" class="form-control" id="jmlh_pesanan" name="jmlh_pesanan" min="1" max="10" value="<?php echo $d['jmlh_pesanan']; ?>" onkeyup=imposeMinMax(this)>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="harga">Harga Gift</label>
                    <div class="col-sm-10">
